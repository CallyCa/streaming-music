...
export let options = {
    ...
    thresholds: {
        http_req_duration: ['p(95)<2000', 'p(99)<3000'], // 95% das requisições devem ser concluídas em menos de 2000 ms, 99% em menos de 3000 ms
...
export function handleSummary(data) {
    return {
        ...
        'tests/reports/graphqlLoadTesting.html': htmlReport(data),
    };
}
